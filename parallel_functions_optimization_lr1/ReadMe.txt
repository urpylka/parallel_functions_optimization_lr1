========================================================================
    КОНСОЛЬНОЕ ПРИЛОЖЕНИЕ. Обзор проекта parallel_functions_optimization_lr1
========================================================================

Это приложение parallel_functions_optimization_lr1 создано автоматически с помощью мастера приложений.

В этом файле представлена сводка содержимого всех файлов, входящих в состав приложения parallel_functions_optimization_lr1.


parallel_functions_optimization_lr1.vcxproj
...
parallel_functions_optimization_lr1.vcxproj.filters
...
parallel_functions_optimization_lr1.cpp
...
StdAfx.h, StdAfx.cpp
    Эти файлы используются для построения файла предкомпилированного заголовка (PCH) с именем parallel_functions_optimization_lr1.pch и файла предкомпилированных типов с именем StdAfx.obj.
